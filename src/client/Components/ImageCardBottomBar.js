                        ...
                        <span className="center-align col s3">
                            ...
                            <ul id='share-dropdown' className='dropdown-content'>
                                <li><a
                                    target="_blank"
                                    href=
                                    {'https://www.reddit.com/submit?url=lightninghosted.com/s' + imageId + '&title=' + title}>

                                    <i className="fa fa-reddit"></i>Reddit</a></li>
                                <li>
                                    <a
                                        target="_blank"
                                        href={'https://www.facebook.com/sharer/sharer.php?u=lightninghosted.com/s' + imageId}>
                                        <i className="fa fa-facebook"></i>Facebook</a></li>
                                <li>
                                    <a
                                        target="_blank"
                                        href={"http://twitter.com/share?text=" + title + "&url=lightninghosted.com/s" + imageId + "&hashtags=LightningHosted"}>
                                        <i className="fa fa-twitter"></i>Twitter</a></li>
                            </ul>
                        </span>
                        :
                        <a
