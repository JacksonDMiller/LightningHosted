  ...
  return (
    <div className={containerClasses()}>
      {share ? (
        <div>
          {title ? (
            <span className="card-title word-break">{title}</span>
          ) : null}
          <div className="card-image">{media()}</div>
          {caption ? (
            <div>
              <p className="flow-text black-text card-content caption-text">
                {caption}
              </p>
            </div>
          ) : null}
          ...
          <span className="center-align col s3 ">
            {globalState.state.upvoted.includes(imageId) ? (
              <i
                ...
                className="material-icons image-icon upvoted upvote"
              >
                keyboard_arrow_up
              </i>
            ) : (
              <i
                ...
                className="material-icons image-icon upvote"
              >
                keyboard_arrow_up
              </i>
            )}
