        ...
        <div className="col s12 m6">
          <div className="card blue-grey darken-1">
            <div className="card-content white-text">
              ...
              <p>
                LightningHosted is eager to hear from the comunity. If you have
                any questions, conerns or sugestions dont hesitate to reach out
                to us.{" "}
              </p>
            </div>
        ...
        <div className="col s12 m6">
          <div className="card blue-grey darken-1">
            <div className="card-content white-text">
              ...
              <p>
                LightningHosted is developed by Jackson Miller to give
                bitcoiners a fun space to experiment with the lightning network.{" "}
              </p>
            </div>
            <div className="card-action">
              <a
